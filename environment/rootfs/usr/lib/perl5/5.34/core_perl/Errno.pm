...
"armv7l-linux-thread-multi-5.12.15-arch1-1" or
	die "Errno architecture (armv7l-linux-thread-multi-5.12.15-arch1-1) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
